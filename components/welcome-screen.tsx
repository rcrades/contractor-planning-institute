  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-8 bg-neutral-900">
      <div className="max-w-md w-full mx-auto text-center">
        ...
        <div className="mt-4">
          <p className="text-sm text-neutral-400">Completely confidential. No obligation.</p>
          <a
            href="/peer-group"
            className="text-sm text-yellow-400 hover:text-yellow-500 mt-2 inline-block transition-colors"
          >
            Explore our peer group matching
          </a>
        </div>
      </div>
    </div>
